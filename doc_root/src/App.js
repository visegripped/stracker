        ...
        <MessageProvider>
          <header className="appHeader">
            ...
            <nav className='app--nav'>
              <li><a href='#symbol' data-view='symbol' onClick={changeView}>Symbol</a></li>
              <li><a href='#alertHistory' data-view='alertHistory' onClick={changeView}>Alert History</a></li>
            </nav>
            <div>
              {/* <AuthButton /> */}
            </div>
          ...
          <main>
            <Messages></Messages>
            {view === 'alertHistory' ? <div>stuff</div> : <InteractiveGraph />}
          </main>
        </MessageProvider>
      </AppProvider>
    </div>
